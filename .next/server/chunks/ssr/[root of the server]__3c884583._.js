...
function ChatWidget({ isOpen, onOpenChange, initialMessage }) {
    ...
    const initialGreetingSentRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(false); // Ref to track if initial greeting was sent
    ...
    const handleSubmitLogic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (messageText)=>{
...
const ThreeCanvas = ()=>{
    ...
    const updateThemeColors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        const getRawHSL = (cssVar, fallbackHsl)=>{
            const hslString = computedRootStyle.getPropertyValue(cssVar).trim();
            if (hslString) {
                const [h, s, l] = hslString.split(' ').map((val)=>parseFloat(val.replace('%', '')));
                if (!isNaN(h) && !isNaN(s) && !isNaN(l)) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$three$2f$ThreeCanvas$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/three/ThreeCanvas.tsx [app-ssr] (ecmascript)"); // ThreeCanvas importado
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTranslations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useTranslations.ts [app-ssr] (ecmascript)");
"use client";
;
;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3c884583._.js.map